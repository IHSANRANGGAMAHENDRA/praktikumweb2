...
.cyber-about-content {
    ...
    <div class="cyber-about-container">
        <h1 class="cyber-about-title cyber-glow"><?= esc($title); ?></h1>
        <div class="cyber-about-divider"></div>
        <p class="cyber-about-content"><?= esc($content); ?></p>
    </div>
<?= $this->endSection(); ?>
